...
public class UserProfileNewEditor extends EditorPart {

    public static final String ID = "com.ingres.demoapp.ui.perspectives.editors.UserProfileNewEditor";
    ...
    private Text emailAddressText = null;
    ...
    private void createPersonalDetailsGroup() {
        ...
        emailAddressText = new Text(personalDetailsGroup, SWT.BORDER);
        emailAddressText.setLayoutData(gridData15);
    ...
    private void createComposite() {
        ...
        addButton.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
            public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
                ...
                userProfile.setEmailAddress(emailAddressText.getText());
    ...
    private void createComposite1() {
        ...
        modifyButton.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
            public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
                ...
                try {
                    profile = UserProfileDAO.getDefaultUserProfile();
                } catch (Exception e1) {
                    e1.printStackTrace();
                }
                UserProfileInput input = new UserProfileInput(profile);
                try {
                    activePage.openEditor(input, UserProfileModifyEditor.ID);
