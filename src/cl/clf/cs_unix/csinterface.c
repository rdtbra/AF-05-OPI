...
# endif
    ...
    */
    ...
    {
	(*Cs_srv_block.cs_elog)( E_CS002E_CS_SHORT_FDS, (DB_ERROR *)NULL,
                                 (CL_ERR_DESC *)0, 1, sizeof( i ), (PTR)&i );
...
STATUS
IICSdispatch(void)
/* RDT: 20230706 - entendo que este código do dispatcher é parte bastante importante no processo do servidor. */
{
  STATUS     status = 0;
  STATUS		 ret_val;
  i4			   i;
...
#define got2   /* nothing needed */
	  ...
	  */
	  ...
	  {
	    (*Cs_srv_block.cs_elog)(E_CS002D_CS_DEFINE, (DB_ERROR *)NULL,
                                    (CL_ERR_DESC *)0, 0);
	  }
    ...
    TRdisplay("->->->->->\n");
	  ...
	  */
	  ...
	  MUset_funcs( MUcs_sems() );
		...
		/* RDT: 2021-05-12 - Parece que estamos chamando uma função que coloca o servidor em modo usuário, o que quer que isso
  ...
  if ( ((status & 1) == 0) || (ret_val) )
  {
	  ...
	  (*Cs_srv_block.cs_elog)(ret_val, (DB_ERROR *)NULL, err_code, 0);
  }
