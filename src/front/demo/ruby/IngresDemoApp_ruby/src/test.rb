...
if (profileTest)
  ...
  dbconnection.connect
#  dbconnection.setDebugFlag("GLOBAL_DEBUG", "TRUE")
#  results = dbconnection.execute("SELECT up_last, up_first, up_email, up_airport FROM user_profile WHERE up_email = ?", "n", "bobby.kent@actian.com")
#  profile = dbconnection.getProfile("bobby.kent@actian.com")
